-- FIX COMPLIANCE DEPENDENCIES V9 (LEGACY COLUMN FIX)
-- Run this entire script in Supabase SQL Editor
-- Fixes: "null value in column 'type' violates not-null constraint" by relaxing legacy constraints
...
-- Fix Legacy Columns (Relax constraints so new schema works)
DO $$
BEGIN
    -- Relax 'type' column if it exists
    ...
    -- Relax 'deadline' column if it exists
